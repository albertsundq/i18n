<%@ Control Language="C#" AutoEventWireup="true" CodeFile="_page.ascx.cs" Inherits="_page_ascx" EnableViewState="false" %>
...
<style>
<!--
#dcms_pager .pages {border:none;text-transform:uppercase;font-size:12px; color:#000000;margin:10px 0 10px 0;padding:0;height:20px;clear:both;text-align: right; margin-right:16px;}
...
<div id="dcms_pager" style="color:#000" >
