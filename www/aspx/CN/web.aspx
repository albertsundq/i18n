<%@ Page Language="C#" AutoEventWireup="true" CodeFile="web.aspx.cs" Inherits="_web_aspx" EnableViewState="false" %>
...
<Dcms:Drepeater ID="Repeater3" runat="server" SqlType="select" SelectDir="this" SwitchDb="" PrimaryKey="BaseInfo_Id" TotalLayer="1" TableName="Dcms_BaseInfo" FieldName="BaseInfo_Content" FieldValue="" Children="0" PageSize="1" IsPage="False" Where="BaseInfo_State='1' and #BaseInfo_CateId={Get.BaseInfoCateId,hzhb}# " OrderBy="BaseInfo_Id Desc">
