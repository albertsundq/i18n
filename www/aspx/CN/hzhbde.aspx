<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hzhbde.aspx.cs" Inherits="_hzhbde_aspx" EnableViewState="false" %>
...
<div class="cright">
                                  <div class="scontent" style="line-height:22px;">
                                    <Dcms:Drepeater ID="Repeater3" runat="server" SqlType="select" SelectDir="this" SwitchDb="" PrimaryKey="News_Id" TotalLayer="1" TableName="Dcms_News" FieldName="News_Title,News_AddTime,News_Count,News_Id,News_Content" FieldValue="" Children="0" PageSize="1" IsPage="False" Where="News_State='1' and News_Id={Get.NewsId,hzhb} " OrderBy="News_Id Desc">
