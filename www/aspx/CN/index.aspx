<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="_index_aspx" EnableViewState="false" %>
...
<div class="wrapper" >
  <div id="focus">
   <ul><Dcms:Drepeater ID="Repeater0" runat="server" SqlType="select" SelectDir="this" SwitchDb="" PrimaryKey="BaseInfo_Id" TotalLayer="1" TableName="Dcms_BaseInfo" FieldName="BaseInfo_Content,BaseInfo_Image" FieldValue="" Children="0" PageSize="10" IsPage="False" Where="BaseInfo_State='1' and #BaseInfo_CateId=banner# " OrderBy="BaseInfo_Id Desc">
	<ItemTemplate0>         <li><a href="{Dcms_BaseInfo.BaseInfo_Content}" target="_blank"><img src="{Dcms_BaseInfo.BaseInfo_Image}" width="600" height="340" /></a></li>              </ItemTemplate0>
</Dcms:Drepeater>
...
<div class="maind"><ul class="hnews " >
            <Dcms:Drepeater ID="Repeater1" runat="server" SqlType="select" SelectDir="thisandallsub" SwitchDb="" PrimaryKey="News_Id" TotalLayer="1" TableName="Dcms_News" FieldName="News_CateId,News_Id,News_Title,News_AddTime" FieldValue="" Children="0" PageSize="5" IsPage="True" Where="News_State='1' and #News_CateId={Get.NewsCateId,news}# " OrderBy="News_AddTime Desc">
                    	<ItemTemplate0>                     <li style="line-height:25px; text-align:left" ><a class="home2"  href="newsde.aspx?newsCateID={Dcms_News.News_CateId}&CateID={Dcms_News.News_CateId}&NewsID={Dcms_News.News_Id}">{Dcms_News.News_Title,36}<span style="font-size:11px">{Dcms_News.News_AddTime,yyyy-MM-dd}</span></a></li>                    </ItemTemplate0>
                    </Dcms:Drepeater>
