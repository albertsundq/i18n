...
<div class="abouttop1"style="padding-top:10px;"><!--Repeater TableName="Dcms_Cate" Where="Cate_State='1' and #Cate_Id=news#" OrderBy="Cate_IdPath asc" SqlType="select" PrimaryKey="Cate_Id" SelectDir="this" PageSize="1" IsPage="False"-->
<!--Item-->
...
<!--Repeater TableName="Dcms_Cate" Where="Cate_State='1' and #Cate_Id=news# " OrderBy="Cate_Id asc" SqlType="select" PrimaryKey="Cate_Id" SelectDir="sub" PageSize="10" IsPage="False"-->
  <!--Item-->
               <li style="line-height:24px; padding-top:3px;"><a  href="news.aspx?newsCateID={Dcms_Cate.Cate_Id}&CateID={Dcms_Cate.Cate_Id}" id="{Dcms_Cate.Cate_Id}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{Dcms_Cate.Cate_Title}</a> </li>
          <!--/Item-->
                                          <!--/Repeater-->
...
<ul class="news" style="padding-top:12px">
  ...
  <!--Repeater TableName="Dcms_News" Where="News_State='1' and #News_CateId={Get.NewsCateId,news}# " OrderBy="News_AddTime Desc" SqlType="select" PrimaryKey="News_Id" SelectDir="this" PageSize="12" IsPage="True"-->
                        <!--Item-->
                        <li><span>{Dcms_News.News_AddTime,yyyy-MM-dd}</span><a class="home2"  href="newsde.aspx?newsCateID={Dcms_News.News_CateId}&CateID={Dcms_News.News_CateId}&NewsID={Dcms_News.News_Id}">{Dcms_News.News_Title}</a></li>
                      <!--/Item-->
                        <!--/Repeater--> 
