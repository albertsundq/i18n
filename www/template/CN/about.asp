...
<!--/Item-->
<!--/Repeater--></li></div>
<!--Repeater TableName="Dcms_BaseInfo" Where="BaseInfo_State='1' and #BaseInfo_CateId={Get.BaseInfoCateId,guanyuwomen}# " OrderBy="BaseInfo_Id Desc" SqlType="select" PrimaryKey="BaseInfo_Id" SelectDir="this" PageSize="1" IsPage="False"-->
                          <!--Item-->
