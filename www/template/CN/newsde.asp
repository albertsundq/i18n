...
<div class="cright">
                                  <div class="scontent" style="line-height:22px;">
                                    <!--Repeater TableName="Dcms_News" Where="News_State='1' and News_Id={Get.NewsId,gongsixinwen} " OrderBy="News_Id Desc" SqlType="select" PrimaryKey="News_Id" SelectDir="this" PageSize="1" IsPage="False"-->
                                    <!--Item-->
