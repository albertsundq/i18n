...
<div class="abouttop1"style="padding-top:10px;"><!--Repeater TableName="Dcms_Cate" Where="Cate_State='1' and #Cate_Id=Contact#" OrderBy="Cate_IdPath asc" SqlType="select" PrimaryKey="Cate_Id" SelectDir="this" PageSize="1" IsPage="False"-->
<!--Item-->
...
<!--Repeater TableName="Dcms_BaseInfo" Where="BaseInfo_State='1' and #BaseInfo_CateId={Get.BaseInfoCateId,Contact}# " OrderBy="BaseInfo_Id Desc" SqlType="select" PrimaryKey="BaseInfo_Id" SelectDir="this" PageSize="1" IsPage="False"-->
                          <!--Item-->
                        <div id="1111" style="padding-right:5px; padding-left:10px; line-height:23px; ">{Dcms_BaseInfo.BaseInfo_Content}</div>
                        <!--/Item-->
                        <!--/Repeater--></div>
